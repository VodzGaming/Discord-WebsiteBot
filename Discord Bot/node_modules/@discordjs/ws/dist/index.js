...
var WebSocketShard = class extends import_async_event_emitter.AsyncEventEmitter {
  ...
  async destroy(options = {}) {
    ...
    this.debug([
      ...
      `Code: ${options.code}`,
      `Recover: ${options.recover === void 0 ? "null" : WebSocketShardDestroyRecovery[options.recover]}`
    ]);
    this.isAck = true;
  ...
  async identify() {
    ...
    this.debug([
      ...
      `compression: ${this.inflate ? "zlib-stream" : this.useIdentifyCompress ? "identify" : "null"}`
    ]);
    const d = {
