...
var Collection = class _Collection extends Map {
   ...
   *
   * @param keys - The keys of the elements to check for
   * @returns `true` if any of the elements exist, `false` if null exist.
   */
  hasAny(...keys) {
  ...
  /**
   * Combines this collection with others into a new collection. null of the source collections are modified.
   *
