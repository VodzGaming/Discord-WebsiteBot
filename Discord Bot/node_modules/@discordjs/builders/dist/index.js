...
var selectMenuStringPredicate = selectMenuBasePredicate.extend({
  ...
  if (value.min_values !== void 0 && value.max_values !== void 0 && value.min_values > value.max_values) {
    return import_shapeshift4.Result.err(
...
var unfurledMediaItemPredicate = import_shapeshift6.s.object({
  url: import_shapeshift6.s.string().url(
    { allowedProtocols: ["http:", "https:", "attachment:"] },
...
var textDisplayContentPredicate = import_shapeshift6.s.string().lengthGreaterThanOrEqual(1).lengthLessThanOrEqual(4e3).setValidationEnabled(isValidationEnabled);
...
var FileBuilder = class extends ComponentBuilder {
   ...
   */
  constructor(data = {}) {
    super({ type: import_v1015.ComponentType.File, ...data, file: data.file ? { url: data.file.url } : void 0 });
  }
  /**
...
var contextsPredicate = import_shapeshift8.s.array(
  import_shapeshift8.s.nativeEnum(import_v1024.InteractionContextType).setValidationEnabled(isValidationEnabled)
);
var integrationTypesPredicate = import_shapeshift8.s.array(
  import_shapeshift8.s.nativeEnum(import_v1024.ApplicationIntegrationType).setValidationEnabled(isValidationEnabled)
);
...
var minLengthValidator2 = import_shapeshift14.s.number().greaterThanOrEqual(0).lessThanOrEqual(6e3);
var maxLengthValidator2 = import_shapeshift14.s.number().greaterThanOrEqual(1).lessThanOrEqual(6e3);
...
var contextsPredicate2 = import_shapeshift15.s.array(
  import_shapeshift15.s.nativeEnum(import_v1038.InteractionContextType).setValidationEnabled(isValidationEnabled)
);
var integrationTypesPredicate2 = import_shapeshift15.s.array(
  import_shapeshift15.s.nativeEnum(import_v1038.ApplicationIntegrationType).setValidationEnabled(isValidationEnabled)
);
